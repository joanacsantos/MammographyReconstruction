...
def main():
    ...
    aligned_images_test = np.concatenate(( images_with_mv_test,images_test),axis=2) #MLOtoCC
    save_images("datasets/mammo/test/", aligned_images_test, SOURCE + "_" + str(run), labels_save_test_a, None, None, INVERT, True)
