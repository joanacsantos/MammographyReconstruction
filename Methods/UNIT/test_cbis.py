...
fakeA = np.zeros((244,256,256,1))
realB = np.zeros((244,256,256,1))
fakeB = np.zeros((244,256,256,1))
    ...
    'output/CBIS_',confexp + ".csv",
        {
            ...
            "MSE": mean_squared_error(realA,fakeA) ,
            "PSNR": mean_psnr(realA,fakeA),
            "SSIM": mean_ssim(realA,fakeA),
            "UQI": mean_uqi(realA,fakeA)
        }) 
