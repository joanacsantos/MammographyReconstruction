...
torch.save(E1.state_dict(), "saved_models/%s/E1_%s.pth" % (opt.dataset_name, "final"))
torch.save(E2.state_dict(), "saved_models/%s/E2_%s.pth" % (opt.dataset_name, "final"))
torch.save(G1.state_dict(), "saved_models/%s/G1_%s.pth" % (opt.dataset_name, "final"))
torch.save(G2.state_dict(), "saved_models/%s/G2_%s.pth" % (opt.dataset_name, "final"))
torch.save(D1.state_dict(), "saved_models/%s/D1_%s.pth" % (opt.dataset_name, "final"))
torch.save(D2.state_dict(), "saved_models/%s/D2_%s.pth" % (opt.dataset_name, "final"))
