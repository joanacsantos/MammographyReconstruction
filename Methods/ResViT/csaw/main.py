...
def single_run_process_aligned(run, np_images,label):
    ...
    images_with_mv_val = aligned_images[700:]
    labels_save_val_b = labels_save_train_b[700:]

    aligned_images = aligned_images[:700]
    labels_save_train_b = labels_save_train_b[:700]
