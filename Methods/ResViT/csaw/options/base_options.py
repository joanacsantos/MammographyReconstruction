...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--run', type=str, default = '0', help='the run number that is currently running')
        self.parser.add_argument('--conf_exp', type=str, default = 'None', help='configuration of the experiment')
