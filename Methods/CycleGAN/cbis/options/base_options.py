...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # parameters from Joana Experiment
        parser.add_argument('--run', type=str, default = '0', help='the run number that is currently running')
        parser.add_argument('--conf_exp', type=str, default = 'None', help='configuration of the experiment')
        # model parameters
